...
// Orthographic Matrix
// NOTE: designed for right-hand, 0 to 1 z NDC space

static inline void CCV_FUNC_MAT_ORTHOGRAPHIC(4)(CCV_MAT_TYPENAME(4) m, ccvType width, ccvType height, ccvType zNear, ccvType zFar)
{
